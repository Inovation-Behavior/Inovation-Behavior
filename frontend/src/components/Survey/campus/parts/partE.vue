<template>
    <el-card style="border-radius: 15px;width: 100%;">
        <el-form :model="form" size="large" label-position="top">
            ...
            <el-form-item class="question" style="font-weight: bolder;" label="E03.贵校是否参加过以下专利运营相关服务？">
            ...
            <el-form-item class="question" style="font-weight: bolder;" label="E04.贵校是否获得过以下专利运营相关的政策资助？">
                <el-form-item class="question blue-label" style="font-weight: bolder;" label="（请打分，1🌟为没有，5🌟为许多次）" />
